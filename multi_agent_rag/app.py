...
# Resolve example file paths relative to this script's location so
# examples load correctly regardless of the process's working directory.
...
EXAMPLES = {
    "Google 2024 Environmental Report": {
        ...
        "file_paths": [os.path.join(BASE_DIR, "examples", "google-2024-environmental-report.pdf")]
    },
    "DeepSeek-R1 Technical Report": {
        "question": "Summarize DeepSeek-R1 model's performance evaluation on all coding tasks against OpenAI o1-mini model",
        "file_paths": [os.path.join(BASE_DIR, "examples", "DeepSeek Technical Report.pdf")]
    }
}
        ...
        def load_example(example_key: str):
            ...
            for path in file_paths:
                if os.path.exists(path):
                    ...
                    logger.info(f"Loaded example file: {path}")
                else:
