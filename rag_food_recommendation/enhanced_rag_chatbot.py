...
Response:'''
        ...
        generated_response = model.chat.completions.create(
            model=MODEL_ID,
        ...
        if generated_response and generated_response.choices:
...
Comparison:'''
        ...
        if generated_response and generated_response.choices:
            return generated_response.choices[0].message.content.strip()
        else:
...
def show_enhanced_rag_help():
    ...
    print("=" * 45)
    print("🧠 This chatbot uses OpenAI to understand your")
