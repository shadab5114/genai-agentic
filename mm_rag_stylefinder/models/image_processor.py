...
class ImageProcessor:
    ...
    def __init__(self, image_size=(224, 224), 
        ...
        # IMAGENET1K_V1 is what the dataset's stored embeddings were built with -
        # the modern spelling of the old resnet50(pretrained=True). Note that
        # ResNet50_Weights.DEFAULT means V2, whose vectors score only ~0.64
        # against the stored ones, so retrieval would quietly stop working.
